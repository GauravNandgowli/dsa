...
public class prevInferiorOccurance {
    public static void main(String[] args) {
        System.out.println();
        int[] arr1 = { 3, 5, 1, 6, 8, 2 };
        int[] arr2 = { 3, 1, 8, 2 };
        int[] res = precedingInferiorElement(arr1, arr2);
        for (int i : res) {
            System.out.println(i);
        }
    }

    public static int[] precedingInferiorElement(int[] arr1, int[] arr2) {
